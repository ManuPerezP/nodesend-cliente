...
const Login = ()=>{
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            password: Yup.string().required('El password no puede ir vacio').min(6,'El password debe contener al menos 6 caraacteres')
        }),
        onSubmit: (valores)=>{
                                ...
                                <div className="mb-4">
                                   ...
                                   />
                                    ...
                                    {formik.touched.email && formik.errors.email ? (
                                       <div className="my-2 bg-gray-200 boder-l-4 border-red-500 text-red-700 p-4">
